...
`;
 ...
 window.customElements.get("modal-content") || window.customElements.define("modal-content", ModalContent);
  ...
  var PredictiveSearchInput = class extends HTMLInputElement {
    connectedCallback() {
      this.addEventListener("click", () => {
        if(document.getElementById(this.getAttribute("aria-controls"))) {
          document.getElementById(this.getAttribute("aria-controls")).open = true
        }
      });
    }
  };
